...
This will create an executable jar file **api-rvr1960-microbundle.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/api-rvr1960-microbundle.jar --port 8180
